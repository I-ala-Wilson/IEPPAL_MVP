      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-8 overflow-auto">
          <form onSubmit={handleNext} className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">Student Strengths & Areas For Growth</h2>
            <div className="mb-6">
              <label className="block text-lg font-medium text-gray-700">Student Strengths</label>
              <textarea
                value={strengths}
                ...
                rows="4"
                placeholder="Include the student's academic and non-academic strengths..."
              ></textarea>
            </div>
            <div className="mb-8">
              <label className="block text-lg font-medium text-gray-700">Student Areas for Growth</label>
              <textarea
                value={areasForGrowth}
                onChange={(e) => setAreasForGrowth(e.target.value)}
                className="mt-2 block w-full border border-gray-300 rounded-2xl p-3 shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-200"
                rows="4"
                placeholder="Include areas where the student may need additional support..."
              ></textarea>
            </div>
